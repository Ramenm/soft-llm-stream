export type StreamStatus = "idle" | "connecting" | "streaming" | "stopping" | "stopped" | "done" | "error";
export type RevealMode = "bootstrap" | "steady" | "protect" | "catchup" | "complete";
...
export type StreamSource = Response | ReadableStream<unknown> | AsyncIterable<unknown>;
export type StreamSourceInput = StreamSource | Promise<StreamSource> | ((signal: AbortSignal) => StreamSource | Promise<StreamSource>);
export type StreamAdapter = {
    name: string;
    consume: (source: StreamSource, context: {
        signal: AbortSignal;
...
export type CreateSoftLlmChatStreamOptions = Omit<CreateSoftLlmStreamOptions, "adapter" | "hiddenPolicy"> & {
    adapter?: StreamAdapter | StreamAdapterName;
    hiddenPolicy?: "flush" | "pause";
};
...
export declare const EMPTY_SNAPSHOT: StreamSnapshot;
export declare const EMPTY_DEBUG_STATE: SoftLlmStreamDebugState;
